...
--                                                                                             (1, '홍길동', '010-1234-5678', '1990-01-01', '남성', 'ACTIVE', '', CURRENT_TIMESTAMP),
--                                                                                             (2, '김영희', '010-2345-6789', '1992-02-02', '남성', 'ACTIVE', '', CURRENT_TIMESTAMP),
--                                                                                             (3, '이동재', '010-2121-6789', '1992-02-02', '남성', 'ACTIVE', '', CURRENT_TIMESTAMP),
--                                                                                             (4, '안태형', '010-3214-6789', '1992-02-02', '남성', 'ACTIVE', '', CURRENT_TIMESTAMP),
--                                                                                             (5, '홍희범', '010-3513-6789', '1992-02-02', '남성', 'ACTIVE', '', CURRENT_TIMESTAMP),
--                                                                                             (6, '이철수', '010-3456-7890', '1991-03-03', '남성', 'INACTIVE', '', CURRENT_TIMESTAMP);
--
--
-- product
...
-- -- membership
-- INSERT INTO membership (membershipId, memberId, productId, paymentId, startDate, endDate, price, memo, isActive, created_at) VALUES
